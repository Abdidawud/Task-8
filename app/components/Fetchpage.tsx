    ...
    <div className="flex justify-center mt-3 ml-7 mr-2">
      <div className="w-3/4 mr-4 p-4  rounded-2xl">
        <div className="my-5">
          ...
          <p className="text-slate-800 w-5/6 font-serif text-sm">
            {data?.data?.description}
          </p>
        </div>

        <div>
          <h2 className="mt-10 mb-5 font-san font-bold text-lg">
            Responsibilities
          </h2>
        ...
        <div>
          <h2 className="mt-10 mb-3 font-san font-bold text-lg">
            Ideal Candidate We Want
          </h2>
          <ul className="list list-disc ml-5">
            <li className="my-1.5">
              <p className="text-sm">
                Young (18-25 Years old) Female Social Media Manager
              </p>
            </li>
            <li className="my-1.5">
            ...
            {(data?.data?.requiredSkills || []).map(
              (
                ...
                <div key={ind} className="flex">
                  <p className="bg-gray-50 border rounded text-sm text-blue-300 p-1.5">
                    {item}
                  </p>
                </div>
              )
